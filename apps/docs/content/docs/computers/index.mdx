...
<ProductScreenshot name="docs-computer-panel" alt="OpenMausBot computer panel offering cloud, local VM, host computer, and off modes" caption="Computer placement is explicit per bot and can be changed without changing its model." />
