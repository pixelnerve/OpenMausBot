...
<ProductScreenshot name="approval-card" alt="An OpenMausBot approval card shown inside a conversation" caption="Approvals stay in context with the request and the agent's explanation." />
