...
<ProductScreenshot name="docs-connected-apps" alt="The clean OpenMausBot connected-app marketplace" caption="Search the marketplace or review every account from the Connected tab." />
