...
<ProductScreenshot name="docs-model-picker" alt="OpenMausBot model picker showing cloud and local agent engines" caption="Models are selected per bot, so a team can mix engines without changing global settings." />
